      ...
      <View style={styles.screen}>
        ...
        <View style={styles.messageContainer}>
          <Text style={styles.message1}>
            To gain knowledge listen meaningful audios here.
          </Text>
          <Text style={styles.message2}>
            Smartly use your idle time, multitask or just listen when you don't
            have time to read.
          </Text>
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.forgetPasswordAndSignUp}>
            <TouchableOpacity onPress={() => {}}>
              <Text
                style={{color: Colors.danger, textDecorationLine: 'underline'}}>
                Forgot Password
              </Text>
            </TouchableOpacity>
