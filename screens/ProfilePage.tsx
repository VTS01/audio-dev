  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.interestSelectorContainer}>
        <Text style={styles.selectYourInterestTitle}>
          Select Your Interest:
        </Text>
        <TouchableWithoutFeedback onPress={handleShowDropDown}>
          <View style={styles.dropDownTextHolder}>
            <Text style={styles.dropDownText}>{selectedInterest}</Text>
            <AntDesign name="caretdown" size={20} color="black" />
          </View>
        </TouchableWithoutFeedback>
        {selectedInterest !== 'Select' ? (
          <View style={styles.submitButtonContainer}>
            <TouchableNativeFeedback onPress={handleSubmitUserInterest}>
      ...
      <View style={styles.buttonContainer}>
        <View style={{overflow: 'hidden', borderRadius: 25}}>
          <TouchableNativeFeedback onPress={handleReferToFriendButtonClick}>
            <View style={styles.referButton}>
              <Text style={styles.buttonText}>Refer Mello to a friend</Text>
              <Fontisto name="persons" size={24} color={Colors.secondary} />
            </View>
          </TouchableNativeFeedback>
        </View>
        <View style={{overflow: 'hidden', borderRadius: 25, marginTop: 10}}>
          <TouchableNativeFeedback onPress={handleFeedBackButtonClick}>
            <View style={styles.feedbackButton}>
              <Text style={styles.buttonText}>Your Feedback</Text>
              <AntDesign name="message1" size={24} color={Colors.secondary} />
            </View>
          </TouchableNativeFeedback>
        </View>
        <View style={styles.logoutButtonContainer}>
          <TouchableNativeFeedback onPress={handleLogoutButtonClick}>
