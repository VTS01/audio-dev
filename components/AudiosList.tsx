                        ...
                        <Card>
                            <View style={styles.item}>
                                ...
                                <View style={styles.durationContainer}>
                                    ...
                                    />
                                    <Text style={styles.durationText}>{returnDuration(item.duration)}</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.creatorInfoContainer}>
                                <View style={styles.creatorAvatarContainer}>
                                    <Image
                                        source={item.userAvatar===null?require('../assets/profile-icon.jpg'):{uri : item.userAvatar}}
                                        style={styles.creatorAvatar}
                                    ></Image>
                                </View>
                                <View style={styles.nameAndSourceNameContainer}>
                                    <Text style={styles.sourceName}>BBC</Text>    
